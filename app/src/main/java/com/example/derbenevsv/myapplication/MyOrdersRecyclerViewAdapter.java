...
import com.example.derbenevsv.myapplication.OrdersFragment.OnListFragmentInteractionListener;
...
public class MyOrdersRecyclerViewAdapter extends RecyclerView.Adapter<MyOrdersRecyclerViewAdapter.ViewHolder>
{
    ...
    public MyOrdersRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener)
    {
        mValues = items;
        mListener = listener;
    }
